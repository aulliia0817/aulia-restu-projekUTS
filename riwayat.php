...
<body class="bg-gray-100 min-h-screen px-4 py-6">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-6 space-y-6">
    <div class="space-y-2">
      ...
      <h3 class="text-lg font-medium text-gray-600">Untuk Balita: <span
          class="font-semibold text-gray-800"><?php echo htmlspecialchars($nama_balita); ?></span></h3>
      <a href="dashboard.php"
        class="inline-block mt-2 text-sm bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
          ...
          <tbody class="divide-y divide-gray-100">
            ...
            while ($riwayat = mysqli_fetch_assoc($result_riwayat)): ?>
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-2">
                  <a href="detail_diagnosis.php?id_hasil=<?php echo $riwayat['id_hasil']; ?>"
