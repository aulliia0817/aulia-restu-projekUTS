...
<body class="bg-gray-100 min-h-screen py-6 px-4">
  ...
  <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md space-y-6 text-center">
    ...
    <div class="text-left space-y-2 text-gray-700">
      ...
      <p><span class="font-medium">Nama Orang Tua:</span> <?php echo htmlspecialchars($hasil['nama_lengkap_user']); ?>
      </p>
      <p><span class="font-medium">Tanggal Diagnosis:</span>
        <?php echo date('d F Y, H:i', strtotime($hasil['tanggal_diagnosis'])); ?></p>
      <p><span class="font-medium">Usia Saat Diagnosis:</span> <?php echo $hasil['catatan_usia_saat_diagnosis']; ?>
        bulan</p>
    </div>
    ...
    <div
      class="text-red-700 bg-red-100 border-2 border-dashed border-red-400 rounded-md px-6 py-4 text-xl font-semibold">
    ...
    <p class="text-xs text-gray-500 leading-relaxed mt-4">
      ...
      Untuk diagnosis yang akurat dan penanganan lebih lanjut, sangat disarankan untuk berkonsultasi langsung dengan
