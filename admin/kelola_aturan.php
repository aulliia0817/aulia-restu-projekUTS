  ...
  <div class="max-w-5xl mx-auto bg-white p-6 rounded-lg shadow space-y-8">
    ...
    <section class="space-y-6">
      ...
      <form method="POST" class="space-y-4 border border-gray-300 p-4 rounded">
        ...
        <button class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" type="submit">Tambah
          Pertanyaan</button>
      </form>
            ...
            <tr>
              ...
              <td class="px-4 py-2">
                <form method="POST" onsubmit="return confirm('Yakin ingin menghapus pertanyaan ini?')">
                  ...
                  <button type="submit" name="hapus_pertanyaan"
                    class="bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700">Hapus</button>
                </form>
              </td>
            </tr>
          <?php endwhile; ?>
    ...
    <section class="space-y-6">
      ...
      <form method="POST" class="space-y-4 border border-gray-300 p-4 rounded">
        ...
        <div>
          ...
          <input type="text" name="kondisi" placeholder="Contoh: G01 AND G03" required
            class="w-full border px-3 py-2 rounded mt-1">
        </div>
        <div>
          <label class="block text-sm text-gray-600">Kesimpulan</label>
          <input type="text" name="kesimpulan" placeholder="Contoh: G07 atau K01" required
            class="w-full border px-3 py-2 rounded mt-1">
        </div>
            ...
            <tr>
              ...
              <td class="px-4 py-2">
                <form method="POST" onsubmit="return confirm('Yakin ingin menghapus aturan ini?')">
                  ...
                  <button type="submit" name="hapus_aturan"
                    class="bg-red-600 text-white px-3 py-1 rounded text-sm hover:bg-red-700">Hapus</button>
                </form>
              </td>
            </tr>
