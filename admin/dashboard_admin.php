...
$recent_diagnosis_query = mysqli_query(
  $koneksi,
...
<body class="bg-gray-100 min-h-screen py-6 px-4">
  ...
  <div class="max-w-7xl mx-auto space-y-10">
    ...
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="bg-white square-lg border-l-4 border-blue-500 shadow p-6 text-center hover:shadow-md transition">
        <div class="text-4xl font-bold text-gray-800"><?php echo $total_users; ?></div>
        <div class="text-gray-600 mt-2">Total Pengguna</div>
      </div>
      <div class="bg-white square-lg border-l-4 border-green-500 shadow p-6 text-center hover:shadow-md transition">
      ...
      <div class="bg-white square-lg border-l-4 border-yellow-400 shadow p-6 text-center hover:shadow-md transition">
    ...
    <section class="bg-white square-lg shadow p-6">
    ...
    <section class="bg-white -lg shadow p-6">
              ...
              <?php while ($row = mysqli_fetch_assoc($recent_diagnosis_query)): ?>
                <tr class="hover:bg-gray-50">
                  <td class="px-4 py-2 border-b text-center">
                    <?php echo date('d M Y, H:i', strtotime($row['tanggal_diagnosis'])); ?>
                  </td>
