...
<body class="bg-gray-100 min-h-screen px-4 py-6">
  <div class="max-w-4xl mx-auto bg-white rounded-lg shadow p-6 space-y-6">
    <div class="space-y-1">
      ...
      <p class="text-sm text-gray-600">Nama Balita: <span
          class="font-medium text-gray-800"><?php echo htmlspecialchars($hasil['nama_balita']); ?></span></p>
      <p class="text-sm text-gray-600">Orang Tua: <span
          class="font-medium text-gray-800"><?php echo htmlspecialchars($hasil['nama_lengkap_user']); ?></span></p>
      <p class="text-sm text-gray-600">Tanggal Diagnosis: <span
          class="text-gray-700"><?php echo date('d F Y, H:i', strtotime($hasil['tanggal_diagnosis'])); ?></span></p>
      <p class="text-sm text-gray-600">Usia Saat Diagnosis: <span
          class="text-gray-700"><?php echo $hasil['catatan_usia_saat_diagnosis']; ?> bulan</span></p>
    </div>
    ...
    <a href="riwayat.php?id_balita=<?php echo $hasil['id_balita']; ?>"
