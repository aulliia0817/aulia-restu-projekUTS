...
<body class="bg-gray-100 min-h-screen py-6 px-4">
    ...
    <div class="max-w-3xl mx-auto bg-white shadow-md rounded-lg p-6 space-y-6">
        <div>
            ...
            <p class="text-gray-600">Untuk Balita: <span
                    class="font-semibold"><?php echo htmlspecialchars($data_balita['nama_balita']); ?></span></p>
            ...
            <?php while ($pertanyaan = mysqli_fetch_assoc($result_pertanyaan)): ?>
                <div class="bg-gray-50 border border-gray-200 rounded-md p-4 shadow-sm">
                    <p class="font-medium text-gray-800 mb-2">
                        <?php echo htmlspecialchars($pertanyaan['teks_pertanyaan']); ?>
                    </p>
                    <div class="flex space-x-6">
                        <label class="inline-flex items-center">
                            <input type="radio" name="jawaban[<?php echo $pertanyaan['kode_gejala']; ?>]" value="ya"
                                required class="text-blue-600 focus:ring-blue-500">
                            <span class="ml-2 text-gray-700">Ya</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" name="jawaban[<?php echo $pertanyaan['kode_gejala']; ?>]" value="tidak"
                                required class="text-red-600 focus:ring-red-500">
